...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Hemos recibido tu pago correctamente. A continuación, los datos más importantes:</p>
            ...
            <p><strong>Fecha de factura:</strong> {{ $invoiceData['invoice']->invoice_date }}</p>
            @endif
            @if(isset($payment->amount))
            <p><strong>Monto pagado:</strong> ${{ number_format($payment->amount, 0, ',', '.') }}</p>
            @endif
